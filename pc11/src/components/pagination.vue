...
<div class="pager">
  ...
  <span v-if="pageNo !== 1" @click="goPage(1)" class="page-index" :class="{active:1 ==current}">1</span>
  ...
  <span @click="goPage(pageNo)" class="page-index" :class="{active:pageNo ==current}">{{pageNo}}</span>
